...
add wave -noupdate -format Literal /system_tb/chr1
add wave -noupdate -format Logic /system_tb/strt
...
add wave -noupdate -format Literal /system_tb/chr2
...
WaveRestoreCursors {{Cursor 1} {15183650100 ps} 0}
...
update
WaveRestoreZoom {14410694450 ps} {27314942450 ps}
